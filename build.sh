...
add_lib "http://ftp.us.debian.org/debian/pool/main/g/gcc-16/libstdc++6_16.2.0-2_amd64.deb" \
    libstdc++.so.6.0.36 libstdc++.so.6
add_lib "http://ftp.us.debian.org/debian/pool/main/g/gcc-16/libgcc-s1_16.2.0-2_amd64.deb" \
